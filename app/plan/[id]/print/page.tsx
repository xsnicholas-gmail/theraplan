...
export default async function PrintablePlanPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <main className="container space-y-6 print-view"><Link className="no-print" href={`/plan/${id}`}>← Back to plan</Link><PlanOverview plan={data as unknown as PlanWithWeeks} /></main>;
}
